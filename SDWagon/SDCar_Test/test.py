...
class ObjectsOnRoadProcessor(object):
    ...
    def __init__(self,
                 car=None,
                 speed_limit=80,
                 model='/home/jetson/SDCar_Simon/models/road_signs_quantized_edgetpu.tflite',
                 label='/home/jetson/SDCar_Simon/models/road_sign_labels.txt',
                 width=640,
                 height=480):
...
def test_stop_sign():
    ...
    object_processor = ObjectsOnRoadProcessor()
    frame = cv2.imread('/home/jetson/DeepPiCar/driver/data/objects/stop_sign.jpg')
    combo_image = object_processor.process_objects_on_road(frame)
    ...
    time.sleep(1)
    frame = cv2.imread('/home/jetson/DeepPiCar/driver/data/objects/green_light.jpg')
    combo_image = object_processor.process_objects_on_road(frame)
...
if __name__ == '__main__':
    ...
    test_photo('/home/jetson/DeepPiCar/driver/data/objects/red_light.jpg')
    test_photo('/home/jetson/DeepPiCar/driver/data/objects/person.jpg')
    test_photo('/home/jetson/DeepPiCar/driver/data/objects/limit_40.jpg')
    test_photo('/home/jetson/DeepPiCar/driver/data/objects/limit_25.jpg')
    test_photo('/home/jetson/DeepPiCar/driver/data/objects/green_light.jpg')
    test_photo('/home/jetson/DeepPiCar/driver/data/objects/no_obj.jpg')
