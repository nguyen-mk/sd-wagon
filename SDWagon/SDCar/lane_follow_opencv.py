...
def map_degree_2_steercmd(x, in_min=30, in_max=150, out_min = 0, out_max = 225):
...
video_orig = create_video_recorder('/home/pi/Videos/car_video%s.avi' % datestr)
video_lane = create_video_recorder('/home/pi/Videos/car_video_lane%s.avi' % datestr)
video_objs = create_video_recorder('/home/pi/Videos/car_video_objs%s.avi' % datestr)
